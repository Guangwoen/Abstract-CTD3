...
def parse_args():
    ...
    parser.add_argument("--project", type=str, help="the path to save project", 
                        ...
                        default="project/20240105-DDPG_risk-lanekeeping-with-model")
    parser.add_argument("--model_config", type=str, help="path of rl algorithm configuration", 
                        
                        default="conf/algorithm/DDPG_risk_lanekeeping.yaml")
...
def build_agent(config, env, gpu, writer):
    ...
    if config["algo_name"] == "TD3":
        ...
        agent = DDPG_risk(config, env.action_space.high[1], gpu, writer=writer)
...
def train(env, eval_env, agent, max_timesteps, max_updates, print_freq, save_freq, 
    ...
    # 保存数据
    data_save_dir = 'lanekeeping/data/risk/ddpg/risk_with_model_data/data'
    plot_save_dir = 'lanekeeping/data/risk/ddpg/risk_with_model_data/plot'
